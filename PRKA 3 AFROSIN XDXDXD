...
#градусы в разных мерах счисления
class Degrees(Enum):
    Celsius, Fahrenheit, Kelvin = "C", "F", "K"
#создание класса с атрибутами, и вывод
class Town:
...
#создание сортировки по возрастанию и убыванию, функция list нужна для создания списка, когда как map требуется для применения функции к каждому объекту кода. (чтобы все было одинаково)
def SortThing(towns):
...
#такой же способ фильтрации, как и выше
...
def ReturnThreeSystems(Object, degreesEnum):
 ...
 #добавляем какие-то города, выводим их
